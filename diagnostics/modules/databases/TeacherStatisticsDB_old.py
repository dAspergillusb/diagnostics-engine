...
#from modules.Types import DataBase
...
class TeacherStatisticsDB:
    ...
    def add_statistics(self, *, subject: str, questions_value: int, firstname: str, lastname: str,
...
if __name__ == '__main__':
    statistics: TeacherStatisticsDB = TeacherStatisticsDB()
