...
class BiologyDB(DataBase):
    ...
    def change_question(self, *, question_id: str, data: dict[str, str]) -> None:
        question: Biology = self.session.query(Biology).get(question_id)
...
if __name__ == '__main__':
    ...
    for question_num in range(21):
        print(_question.session.query(Biology).all()[question_num].question_name)
