...
class ProbabilityTheory(BASE):
    """
    class base of table for database with questions for probability theory subject.
    """
    __tablename__: str = "probability_theory"
...
class ProbabilityTheoryDB(DataBase):
    """
    Class creates or connects to database with questions for tests with probability theory subject. Class can create new question
    in database.
    """
    def __init__(self, db_name: str = "probability_theory_db"):
    ...
    def add_question(self, *, q_number: int, q_title: str, q_text: str, school_class: str,
        ...
        question: ProbabilityTheory = ProbabilityTheory(
            q_number=q_number,
            q_title=q_title,
            q_text=q_text,
    ...
    def change_question(self, *, question_id: str, data: dict[str, str]) -> None:
        question: ProbabilityTheory = self.session.query(ProbabilityTheory).get(question_id)
...
if __name__ == '__main__':
    _question = ProbabilityTheoryDB("../database/probability_theory_db")
    ...
    for question_num in range(17):
        print(_question.session.query(ProbabilityTheory).all())
