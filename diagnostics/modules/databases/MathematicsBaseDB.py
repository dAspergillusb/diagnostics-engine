...
class MathematicsBase(BASE):
    """
    class base of table for database with questions for mathematics subject with base difficulty for 10-11 classes.
    """
    __tablename__: str = "mathematics_base"
...
class MathematicsBaseDB(DataBase):
    ...
    def add_question(self, *, q_number: int, q_title: str, q_text: str, school_class: str,
        ...
        question: MathematicsBase = MathematicsBase(
            q_number=q_number,
            q_title=q_title,
            q_text=q_text,
    ...
    def change_question(self, *, question_id: str, data: dict[str, str]) -> None:
        question: MathematicsBase = self.session.query(MathematicsBase).get(question_id)
...
if __name__ == '__main__':
    _question = MathematicsBaseDB("../database/mathematics_db")
    ...
    for question_num in range(17):
        print(_question.session.query(MathematicsBase).all())
