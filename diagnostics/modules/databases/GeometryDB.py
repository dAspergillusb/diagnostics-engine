...
class GeometryDB(DataBase):
    ...
    in database.
    """
    def __init__(self, db_name: str = "geometry_db"):
    ...
    def change_question(self, *, question_id: str, data: dict[str, str]) -> None:
        question: Geometry = self.session.query(Geometry).get(question_id)
...
if __name__ == '__main__':
    ...
    for question_num in range(21):
        print(_question.session.query(Geometry).all()[question_num].question_name)
