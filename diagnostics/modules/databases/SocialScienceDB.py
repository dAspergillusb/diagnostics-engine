...
class SocialScience(BASE):
    """
    class base of table for database with questions for Social Science subject.
    """
    __tablename__: str = "social_science"
...
class SocialScienceDB(DataBase):
    """
    Class creates or connects to database with questions for tests with Social Science subject. Class can create new question
    in database.
    """
    def __init__(self, db_name: str = "social_science_db"):
    ...
    def add_question(self, *, q_number: int, q_title: str, q_text: str, school_class: str,
        ...
        question: SocialScience = SocialScience(
            q_number=q_number,
            q_title=q_title,
            q_text=q_text,
    ...
    def change_question(self, *, question_id: str, data: dict[str, str]) -> None:
        question: SocialScience = self.session.query(SocialScience).get(question_id)
...
if __name__ == '__main__':
    ...
    for question_num in range(21):
        print(_question.session.query(SocialScience).all()[question_num].question_name)
