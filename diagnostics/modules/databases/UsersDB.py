...
class Users(BASE):
    ...
    email: Column[String] = Column(String(100), nullable=False)
...
class UsersDB:
    ...
    def add_instance(self, *, firstname: str, lastname: str, sex: str, email: str, school_class: str | None,
                     username: str, password: str, rank: str = "student", subject: list[str] = None) -> bool | None:
        user = Users(
            firstname=firstname,
            lastname=lastname,
            sex=sex,
